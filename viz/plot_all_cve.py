...
fig.update_layout(
    font=dict(size=14),
    title={
        'text': f"Top CVEs (CVSS >= 4.0 (medium)) seen among {pretty_count} total vulns in the set generated by {pretty_hosts_count} hosts",
        'font': {
            'size': 28,
            'color': 'black'
        },
...
# Save the plot
fig.write_html(f"viz/output/{WORKINGDIR}-all_cve.html", auto_open=True)
