...
fig.update_layout(
    font=dict(size=14),
    title={
        'text': f"Top 50 open ports seen among {pretty_count} total in the set generated by {pretty_hosts_count} hosts",
        'font': {
            'size': 28,
            'color': 'black'
        },
...
# Save the plot
fig.write_html(f"viz/output/{WORKINGDIR}-top50_ports.html", auto_open=True)
