...
def get_files_to_work_on():
    prepared_file_list = []
    directories = ['DHQ/dbs', 'adho/dbs']
    file_list = [os.path.join(dir_path, file) for dir_path in directories for file in os.listdir(dir_path)]
...
def main():
    ...
    disk_con = sqlite3.connect(working_file_name)
